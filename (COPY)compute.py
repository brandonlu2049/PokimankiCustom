...
def MultiPokemon(
    ...
    shigeTaskTimer.start("FirstPokemon")
    FirstPokemon()
    shigeTaskTimer.end("FirstPokemon")
    ...
    shigeTaskTimer.start("MultiPokemon-for-loop-01")
    ...
    shigeTaskTimer.end("MultiPokemon-for-loop-01")
    ...
    shigeTaskTimer.start("MultiStats")
    results = MultiStats(wholeCollection)
    shigeTaskTimer.end("MultiStats")
