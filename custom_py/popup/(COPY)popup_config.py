...
from aqt import QAction, QDialog, QHBoxLayout, QIcon, QMenu, QResizeEvent, QTextBrowser, Qt, qconnect
...
# mini-pupup
SIZE_MINI_WIDTH = 645
SIZE_MINI_HEIGHT = 482
# Width: 645, Height: 458
# Width: 645, Height: 482
...
THE_ADDON_NAME = "🎮️Pokemanki Gold - Raising Pokemon with Anki (Forked by Shige)"
SHORT_ADDON_NAME = "🎮️Pokemanki Gold"
...
2024-10-14
[ 🔥Enhanced ]
    - Added Pokemon to Reviewer (Beta).
        - Extends Anki's top toolbar to display Pokemon and decks or tags on the answer screen.
        - This function can be optionally disabled.
    - Added trade function to Tagmon.
    - Added an option to hide Pokeball on toolbar.
    - Adjusted message window.

[ 🐞Bug fixed ]
    - Fixed a bug when changing profiles
        - It should work without restarting.
    - Fixed non working tags menu in tagmon
        - You can change tags by pressing Tags in the menu.

2024-11-04 : Stunfisk is flat so I changed the Gif.
"""
...
CHANGE_LOG_TEXT_B = """\
Shigeyuki :
Hello Pokemon trainer, thank you for using this add-on!😆

I development of Anki Add-ons for Gamification Learning and so far I fixed 40+ broken add-ons. If you like this add-on, please support my development on Patreon, and you can get add-ons for patrons only(about 28 Contents).

If you have any problems or requests feel free to contact me. Thanks!
...
#         change_log_label = QLabel(change_log_text)
#         change_log_label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
#         hbox.addWidget(icon_label)
#         hbox.addWidget(change_log_label)
...
# def toggle_rate_this():
#     config = mw.addonManager.getConfig(__name__)
#     config[CHANGE_LOG] = CHANGE_LOG_DATE
#     mw.addonManager.writeConfig(__name__, config)
